...
if run_btn:
    try:
        ...
        with tabs[2]: # CHART (SMA + RSI + EVENTS)
            ...
            # --- HARDENED EARNINGS/DIVIDENDS MARKERS ---
            ...
            try:
                ...
                if isinstance(cal, pd.DataFrame) and "Earnings Date" in cal.index:
                    ...
                    if not isinstance(e_dates, list): e_dates = [e_dates]
                    for ed in e_dates:
        ...
        with tabs[4]: # AI THESIS (QUALITATIVE)
            ...
            news = stock.news
            b1, b2 = st.columns(2)
            h1 = news[0].get('title', 'Market Sentiment Catalyst') if news else 'Revenue Acceleration'
            h2 = news[1].get('title', 'Operational Constraints') if len(news) > 1 else 'Multiple Compression Risk'
